# Salubra's Blessing% Charm Menu Order route (for any 1.2+ patch, assumes 1.4+)
...
- No Soul Eater
- Head back past the elevator and hit the lever underneath Xero
...
- Head back and rescue the external Hive grub (39)
