...
- Resting Grounds (requires VS)
- Glade of Hope (requires 200 essence, claw)
- Howling Cliffs (requires claw)
- Forgotten Crossroads (requires claw)
- Mantis Village (requires claw)
- City Storerooms (requires claw)
- Deepnest (requires claw)
- Ancient Basin (requires claw)
- Hive (requires tram pass, wings or claw+pogo)
- Kingdom's Edge (requires claw)
- Ancestral Mound (requires wings or claw+pogo)
- Crystal Peak (requires wings or claw+pogo)
- Greenpath (requires CH)
- Fog Canyon (requires CH)
- Queen's Gardens (requires CH)
